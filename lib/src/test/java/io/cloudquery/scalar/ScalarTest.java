...
public class ScalarTest {
  ...
  public void shouldCreateScalarFromArrowType(
      ArrowType arrowType, Class<? extends Scalar<?>> scalarClazz) {
  ...
  public static Stream<Arguments> testDataSource() {
    return Stream.of(
        // Timestamp
        Arguments.of(
            new ArrowType.Timestamp(TimeUnit.MILLISECOND, ZoneOffset.UTC.toString()),
            Timestamp.class),
        ...
        // Float
        // Arguments.of(  new ArrowType.FloatingPoint(FloatingPointPrecision.HALF),
        // Number.Float16.class),
        Arguments.of(
            new ArrowType.FloatingPoint(FloatingPointPrecision.SINGLE), Number.Float32.class),
        Arguments.of(
            new ArrowType.FloatingPoint(FloatingPointPrecision.DOUBLE), Number.Float64.class),
