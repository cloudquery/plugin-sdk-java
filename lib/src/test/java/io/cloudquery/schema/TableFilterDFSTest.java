...
public class TableFilterDFSTest {
  public static final List<Table> BASIC_TABLES =
      Stream.of("table1", "table2", "table3")
          .map(name -> Table.builder().name(name).build())
          .toList();

  public static final List<Table> NESTED_TABLE =
      List.of(
          Table.builder()
              .name("main_table")
              .relations(
                  List.of(
                      Table.builder()
                          .name("sub_table")
                          .relations(List.of(Table.builder().name("sub_sub_table").build()))
                          .build()))
              .build());
  ...
  public void shouldReturnAllTables() throws SchemaException {
    ...
    List<Table> filteredTables =
        Table.filterDFS(BASIC_TABLES, includeConfiguration, EMPTY_CONFIGURATION, false);
  ...
  public void shouldFilterTables() throws SchemaException {
    ...
    List<Table> filteredTables =
        Table.filterDFS(BASIC_TABLES, includeConfiguration, skipConfiguration, false);
  ...
  public void shouldReturnTheParentAndAllDescendants() throws SchemaException {
    ...
    List<Table> filteredTables =
        Table.filterDFS(NESTED_TABLE, includeConfiguration, EMPTY_CONFIGURATION, false);

    assertThat(extractTableNames(filteredTables))
        .containsOnly("main_table", "sub_sub_table", "sub_table");
  }
  ...
  public void shouldThrowExceptionIfNoIncludeMatches() {
    ...
    SchemaException schemaException =
        assertThrows(
            ...
            () -> Table.filterDFS(NESTED_TABLE, includeConfiguration, EMPTY_CONFIGURATION, false));
    assertEquals(
        "table configuration includes a pattern \"" + tableMatch + "\" with no matches",
  ...
  public void shouldThrowExceptionIfNoExcludeMatches() {
    ...
    SchemaException schemaException =
        assertThrows(
            SchemaException.class,
            () -> Table.filterDFS(NESTED_TABLE, includeConfiguration, skipConfiguration, false));
    assertEquals(
        "skip configuration includes a pattern \"" + tableMatch + "\" with no matches",
        schemaException.getMessage());
  }
            ...
            Table.builder()
                ...
                .relations(
                    List.of(
                        Table.builder()
                            .name("sub_table_1")
                            .parent(Table.builder().name("main_table").build())
                            .build(),
                        Table.builder()
                            .name("sub_table_2")
                            .parent(Table.builder().name("main_table").build())
  ...
  @Test
  public void shouldSkipChildTablesIfSkipDependentTablesIsTrueButNotIfExplicitlyIncluded()
            ...
            Table.builder()
                ...
                .relations(
                    List.of(
                        Table.builder()
                            .name("sub_table_1")
                            .parent(Table.builder().name("main_table_1").build())
                            .build()))
                .build(),
            Table.builder()
                .name("main_table_2")
                .relations(
                    List.of(
                        Table.builder()
                            .name("sub_table_2")
                            .parent(Table.builder().name("main_table_2").build())
                            .build(),
                        Table.builder()
                            .name("sub_table_3")
                            .parent(Table.builder().name("main_table_2").build())
    ...
    assertThat(extractTableNames(filteredTables))
        .containsOnly("main_table_1", "main_table_2", "sub_table_2");
  }
