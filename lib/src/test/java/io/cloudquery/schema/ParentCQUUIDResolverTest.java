...
class ParentCQUUIDResolverTest {
  ...
  private static final Column COLUMN =
      Column.builder().name(CHILD_COLUMN).type(new UUIDType()).build();
  private static final Table parentTable =
      Table.builder().name("parent").columns(List.of(Column.CQ_ID_COLUMN)).build();
  private static final Table childTable =
      Table.builder().name("child").columns(List.of(COLUMN)).build();
  ...
  @Test
  public void shouldSetColumnToNullIfWeDoNotHaveAParent()
  ...
  @Test
  public void shouldSetColumnToNullIfParentDoesNotHaveCQID()
      throws TransformerException, ValidationException {
    Resource resource =
        Resource.builder()
            .table(childTable)
  ...
  @Test
  public void shouldSetColumnToUUIDIfParentHasACQID()
      throws TransformerException, ValidationException {
